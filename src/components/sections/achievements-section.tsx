...
const achievements = [
  { title: "International Olympiads", description: "Achieved International Ranks 178, 260, 342, and 545 in the Math, Science, and Cyber Olympiads. Awarded 14x Gold medals over the years 2014-15 to 2021-22." },
  { 
    title: "Academics", 
    description: (
      <>
